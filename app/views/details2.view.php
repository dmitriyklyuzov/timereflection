...
<html>
	...
	<body style="">
			...
			<div class="col-sm-5 col-xs-12 padding-top-2em clearfix" id="imageDiv">
				<?php 
					if($listing -> hasImages($listing->getListingId())){ ?>
						<div class="sp-loading"><img src="/public/img/loading-watch.gif" alt=""><br>LOADING IMAGES</div>
						<div class="sp-wrap">
							<?php echo 'hello!'; // $listing -> getImages(); ?>
							<a href="/public/img/watches/rolex-daytona-2.jpg"><img src="/public/img/watches/rolex-daytona-2.jpg" alt=""></a>
							<a href="/public/img/watches/Rolex-Submariner-Date-16610.jpg"><img src="/public/img/watches/Rolex-Submariner-Date-16610.jpg" alt=""></a>
						</div>
					<?php 
					}
					else{
		...
		<?php endif; ?>
		<script type="text/javascript" src="/public/js/smoothproducts.min.js"></script>
		<script type="text/javascript">
