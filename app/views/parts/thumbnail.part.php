<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
	<div class="thumbnail no-rounded-corners">
		<p class="text-center padding-top-1em"><?php echo toCamelCase($brand) .' '. toCamelCase($model); ?></p>
		<!-- <?php echo $break; ?> -->
		<hr>
		...
		<div id="details" class="padding-left-1em">
			<p><b>Brand:</b> <?php echo toCamelCase($brand); ?></p>
			<p><b>Model:</b> <?php echo toCamelCase($model); ?></p>
